...
import 'package:do_an_chuyen_nganh/resources/local_db/interface/log_interface.dart';
...
class SqliteMethods implements LogInterface {
  ...
  Future<Database> get db async {
    ...
    print("db was null, now awating it");
    _db = await init();
    return _db;
  }
  ...
  _onCreate(Database db, int version) async {
    String createTableQuery =
        "CREATE TABLE $tableName ($id INTEGER PRIMARY KEY, $callerName TEXT, $callerPic TEXT,"
